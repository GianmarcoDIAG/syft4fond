...
#ifndef LTLFFONDDOMAIN_H
#define LTLFFONDDOMAIN_H
...
namespace Syft {
    ...
    class LTLfFONDDomain {
        protected:
            ...
            //std::string parse_goal(const LTLfFONDDomain& domain, std::string& ltlf_goal) const;
        ...
        public:
          std::string parse_goal(const Domain& domain, std::string& ltlf_goal) const;
            ...
            SymbolicStateDfa product(const LTLfFONDDomain& domain);

            SynthesisResult run(bool is_interactive);
